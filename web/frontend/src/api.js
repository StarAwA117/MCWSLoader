...
export const api = {
	...
	disconnectClient: (id) => request(`/clients/${id}/disconnect`, { method: "POST" }),
	...
	killProcess: () => request("/system/kill", { method: "POST" }),
	restartServer: () => request("/system/restart", { method: "POST" }),
